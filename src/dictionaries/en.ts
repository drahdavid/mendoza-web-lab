  ...
  packages: {
    ...
    cards: {
      start: {
        ...
        waText:
          "Hello Web Lab, I'm interested in the Start Pack (from $190,000). I would like more info.",
      },
      pro: {
        badge: "Pro Pack",
        title: "Pro Presence",
        ...
        excludes: [],
        waText:
          "Hello Web Lab, I'm interested in the Pro Pack (from $780,000). I would like more info.",
      },
      marcaWeb: {
        ...
        excludes: [],
        waText:
          "Hello Web Lab, I'm interested in the Brand + Web Pack (from $1,480,000). I would like more info.",
      },
    },
    compare: {
      headers: {
  ...
  faq: {
    ...
    items: {
      ...
      maintenance: {
        ...
        a: "We offer a Monthly Maintenance Plan starting at $70,000/month which includes hosting, bug fixes, minor updates, and monitoring. If you prefer to manage it yourself, we hand it over fully documented.",
      },
    },
  },
  footer: {
