...
export const getCompareRows = (dict: Dictionary): CompareRow[] => [
  {
    label: dict.packages.compare.rows.businessStage.label,
    start: dict.packages.compare.rows.businessStage.start,
    pro: dict.packages.compare.rows.businessStage.pro,
    marcaWeb: dict.packages.compare.rows.businessStage.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.primaryGoal.label,
    start: dict.packages.compare.rows.primaryGoal.start,
    pro: dict.packages.compare.rows.primaryGoal.pro,
    marcaWeb: dict.packages.compare.rows.primaryGoal.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.brandStrategy.label,
    start: dict.packages.compare.rows.brandStrategy.start,
    pro: dict.packages.compare.rows.brandStrategy.pro,
    marcaWeb: dict.packages.compare.rows.brandStrategy.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.websiteStrategy.label,
    start: dict.packages.compare.rows.websiteStrategy.start,
    pro: dict.packages.compare.rows.websiteStrategy.pro,
    marcaWeb: dict.packages.compare.rows.websiteStrategy.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.googlePresence.label,
    start: dict.packages.compare.rows.googlePresence.start,
    pro: dict.packages.compare.rows.googlePresence.pro,
    marcaWeb: dict.packages.compare.rows.googlePresence.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.growthInfrastructure.label,
    start: dict.packages.compare.rows.growthInfrastructure.start,
    pro: dict.packages.compare.rows.growthInfrastructure.pro,
    marcaWeb: dict.packages.compare.rows.growthInfrastructure.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.optimizationDepth.label,
    start: dict.packages.compare.rows.optimizationDepth.start,
    pro: dict.packages.compare.rows.optimizationDepth.pro,
    marcaWeb: dict.packages.compare.rows.optimizationDepth.marcaWeb,
  },
  {
    label: dict.packages.compare.rows.strategicRefinement.label,
    start: dict.packages.compare.rows.strategicRefinement.start,
    pro: dict.packages.compare.rows.strategicRefinement.pro,
    marcaWeb: dict.packages.compare.rows.strategicRefinement.marcaWeb,
  },
];
